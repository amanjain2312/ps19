                  ...
                  <View style={{
                    ...
                    <View style={{paddingBottom: 20}}>
                        ...
                        <Text style={{fontSize: 15,
                           ...
                           Participation: Individual or Team of 2 or 3
                        </Text>
                          <Text style={{fontSize: 15,
                                }}>
                           Registration Fee: 150 INR per Individual/Team
                        </Text>
                        <Text style={{fontSize: 15,
                              }}>
                         Prize Money: 1st – 2000/- & 2nd – 1500/-
                      </Text>
                          <Text style={{fontSize: 15,
                                }}>
                           Date: 14/09/2019
                    ...
                    <View>
                      ...
                      }}>2. The decision of the event coordinator is final. 

                         </Text>
                       <Text style={{paddingBottom: 20,
                        fontSize: 15,

                      }}>3. Teams helping out each other would be disqualified.

         </Text>
			  <Text style={{paddingBottom: 20,
                        fontSize: 15,

                      }}>4. Participants have to bring their own laptop.
