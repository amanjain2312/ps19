                        ...
                        <Text style={{fontSize: 15,
                         ...
                         Prize Money: 1st – 1500/- & 2nd – 1000/-
                          ...
                          <Text style={{fontSize: 15,
                           ...
                           Date: 14/09/2019 and 15/09/2019
                        </Text>
                          <Text style={{fontSize: 15,
                              }}>
                           Time: DAY 1- 12:00PM - 5:00PM ;
				DAY 2- 10:00AM - 5:00PM
                        </Text>
                          <Text style={{fontSize: 15,
                            }}>
                           Venue:CR1,IE lab IEM Dept, Mech block.
                    ...
                    <View>
                      ...
                      }}>1. Use of Phone is not allowed.
</Text>
                         <Text style={{paddingBottom: 20,
                        fontSize: 15,

                      }}> 2. The Team has to finish the tasks as to obtain both the codes.

                         </Text>
                       <Text style={{paddingBottom: 20,
                        fontSize: 15,

                      }}> 3. Combination of both the code unlocks the final lock.

           		</Text>
                       <Text style={{paddingBottom: 20,
                        fontSize: 15,

                      }}>4. Team completing this in the least amount of time wins.
