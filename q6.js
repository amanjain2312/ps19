            ...
            <View style={{paddingLeft:13,
                  ...
                  <View style={{
                    ...
                    <View>
                      ...
                      }}>ROUND 1: The participants (team of 2/3) will go around the venue searching for components based on the clues given to qualify to the next round.
The Teams which find the maximum components in less time gets selected to next round.  
</Text>
                         <Text style={{paddingBottom: 20,
                        fontSize: 15,
