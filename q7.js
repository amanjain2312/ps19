            ...
            <View style={{paddingLeft:13,
                  ...
                  <View style={{
                    ...
                    <View>
                      ...
                      }}>Round 1: Decrypt as many codes as you can to find different sources of energy in a race against time. Multiple puzzles to solve to get sources of energy in 7 minutes. No external help allowed. All teams pass

</Text>
                         <Text style={{paddingBottom: 20,
                        fontSize: 15,

                      }}>Round 2: Use decrypted sources of energy in a crisis and save your world. Only decrypted sources of energy can be used to solve an energy crisis situation, bonus points for using sustainable sources. (15-20 minutes time to prepare).
